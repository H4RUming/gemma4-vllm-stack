...
| Proxy              | FastAPI in separate `.venv-proxy` (no torch)    | Logging, sampling defaults, thinking-param normalization. See [ADR-005](docs/adr/005-logging-proxy-separation.md). |
